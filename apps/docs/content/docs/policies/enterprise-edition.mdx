...
<Accordions type="multiple">
  ...
  <Accordion title="VilnoEDO Runtime">
    VilnoEDO self-hosted runtime no longer uses the Documenso license key or license server. If an enterprise-grade
    feature is needed later, implement and document it as a VilnoEDO capability instead of depending on the removed
    Documenso license flow.
  </Accordion>
</Accordions>
